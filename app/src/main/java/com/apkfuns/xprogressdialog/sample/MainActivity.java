...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        if (v.getId() == R.id.click1) {
            dialog = new XProgressDialog(this, "数据加载中...", XProgressDialog.THEME_HORIZONTAL_SPOT);
        } else if (v.getId() == R.id.click2) {
            dialog = new XProgressDialog(this, "数据加载中...", XProgressDialog.THEME_CIRCLE_PROGRESS);
        } else if (v.getId() == R.id.click3) {
            dialog = new XProgressDialog(this, "数据加载中...", XProgressDialog.THEME_HEART_PROGRESS);
        }
